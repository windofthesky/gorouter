...
// New function to agg egress rules.. DOES NOT WORK!!!!
func NewEgressMarkRule(destinationIP string, tag string) IPTablesRule {
	return IPTablesRule{
		"-d", destinationIP, "--jump", "MARK", "--set-mark", fmt.Sprintf("0x%s", tag),
	}
}
