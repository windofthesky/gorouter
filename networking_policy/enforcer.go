...
func NewEnforcer(logger lager.Logger, timestamper TimeStamper, ipt IPTablesAdapter) *Enforcer {
	return &Enforcer{
		Logger:      logger,
		timestamper: timestamper,
		iptables:    ipt,
...
func (e *Enforcer) EnforceOnChain(c Chain, rules []IPTablesRule) error {
...
func (e *Enforcer) cleanupOldChain(table, parentChain, timeStampedChain string) error {
	err := e.iptables.Delete(table, parentChain, IPTablesRule{"-j", timeStampedChain})
	if err != nil {
